...
cl = LINETCR.LINE()
cl.login(token="EpO5F8ys0JwlFHBcd3l1.ErywMPTSB79NoK7GOcCnaq.0oY1a6CzFFsR2vCMI33aYQH7KEzKpLluHTMmLieLqUQ=")

#ki = LINETCR.LINE()
#ki.login(token="EpzxUeyvov0KJbZZg9cd.9sQ3gy64b+cuzcMzBI7NBq.nCt27Zuf5W4eWvSYEnGtL6dWVJlNjVP4IGHhyBwr0g0=")
...
Bots=[mid,"u7916169a9b6c6fbf673a4ee0a0270d01"]
admin=["u7916169a9b6c6fbf673a4ee0a0270d01"]
wait = {
    'contact':False,
    'autoJoin':True,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
              if wait ["tag"] == True:
                    ...
                    balas = [cName + " Hayoo naksir yaa ?",cName + " Apaan sih ?",cName + " Pm aja sih say",cName + " Knpa ? Kangen ?"]
