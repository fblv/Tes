...
cl = LINETCR.LINE()
cl.login(token="Eo568XQ7eILCd0VPxuSc.s5j09Ybg3Z5ob8cWT2naRa.Yda4ICYeBsBZ8YXIaKhofewuprrNWxSijbphC5RtSU4=")

ki = LINETCR.LINE()
ki.login(token="EpFojpkxCsRnSW5FHCZ0.AqSFIeitoU6MXgAQRn3EOa.RuAKquqtSeEWFdNaOzzA5oKcieIWMnKVToiOF/Bwv74=")

#kk = LINETCR.LINE()
#kk.login(token="EoLzGVUOsx2O2xsJGd1e.ZzTDceWPdlfxDTwDMNsalG.vDytWFEHXTXz5g6f8NMHMD852ALO3ygjjkiqSb59Glo=")
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,"u4b9274f72046df3e4e07c0b0b76340ac","u690b1f8842133aeea6c466aaacdddea0"]
admin = ["u4b9274f72046df3e4e07c0b0b76340ac"]
owner = ["u4b9274f72046df3e4e07c0b0b76340ac"]
creator=["u4b9274f72046df3e4e07c0b0b76340ac"]
wait = {
    'contact':False,
    'autoJoin':True,
                ...
                if targets ==[]:
                        ...
                        for target in targets:
                                try:
                                        ...
                                        ki.sendText(msg.t,"Maaf Akun Sedang Limit!!")
                                        ki.leaveGroup(msg.to)
                                        gs = cl.getGroup(msg.to)
