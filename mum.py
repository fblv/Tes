...
cl = LINETCR.LINE()
cl.login(token="EqJJopt85iz7tFB3FRm5.22z7fVEcJaZnP99j20T1vq.IGJRcVdUg/UzPhcckttuQV6PVXifD8MVmtnOmNKxM0A=")

#ki = LINETCR.LINE()
#ki.login(token="EpvO5RkwrROOCkgTlxV3.GtL6bwcykD5v63zNHBb+4W.tQPA4ujq4lSluIM9GfcYm/c3rUsduar2wqWdyngVL2A=")

#kk = LINETCR.LINE()
#kk.login(token="EpW6H8lzoIcNlADjTio3.GtL6bwcykD5v63zNHBb+4W.YuethYtwwq+lsj5E7nS5/zmgngJ37C0Tn5c5TRaSxTk=")
...
Bots=[mid,"udb667b16f7828c0ccda7df49db4b7555"]
admin=["udb667b16f7828c0ccda7df49db4b7555"]
wait = {
    'contact':False,
    'autoJoin':True,
