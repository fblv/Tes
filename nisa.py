...
cl = LINETCR.LINE()
cl.login(token="Eo196sp625ufKLLf0W6c.KBtylGF7T07g2h8DyG87Ja.1lFmvOYGSAJhH9RZiTgEKcnQ5GC4XXNX7f+FehEDUOU=")

#ki = LINETCR.LINE()
#ki.login(token="EoXjFT7mMdBNB9RZZ8n5.wNscV7bFy8oCGrv6ubp65q.QvNtOvcqsORcGCAqWPcQ7Q84v9G13kNZ/m1lCdTPd1s=")

#kk = LINETCR.LINE()
#kk.login(token="EouQXNTXnW5Lo3Z4oiR5.tM/Pv45LGxbirmRawHhvzq.l3eYRIA6wNCq9k/fQgtI4p7f4PRsKlpsX7lmun4I0Sk=")

#kc = LINETCR.LINE()
#kc.login(token="EoBSbnOx1SOJO54An7ha.OUJk2OaZK4HA5Ypnn2aaoG.7ViYv6FFMIe3Wu7cJrkEj95kXpovZiMXKoHwoLOac2g=")
...
helpMessage =""" 🔯Pasukan Cindil BOT Menu V.3  􀔃􀄆red check mark􏿿
...
Bots=[mid,"u91b4d82e07fbb74ec6d87f1d620f3b8c"]
        ...
        if op.type == 26:
            ...
            if "@"+cl.getProfile().displayName in msg.text:
                    if wait["tag"] == True:
                        ...
                        jawab = (cl.getProfile().displayName+" Ciee ngetag aku ciee\nhati2 ntar baper loh 😏")
                        jawaban = (jawab)
...
#----------------------------------------------------------------------------
       #-------------Fungsi Respon Start---------------------#
                ...
                ki.sendText(msg.to,"Ciblek hadir..")
                kk.sendText(msg.to,"Brindil hadir...")
                kc.sendText(msg.to,"Kadal hadir...")
