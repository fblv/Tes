...
cl = LINETCR.LINE()
cl.login(token="Eq5siiXIVQmF31pSGKY6.GItEPPo3KF5bNMU2uBeALG.fKEVqdtWOAELw7gVFEJJyMldOm6+XF6lbcD4/0p5lhI=")
...
Bots=[mid,"u8224dea693b791fe419e6bb651b11a96"]
admin=["u8224dea693b791fe419e6bb651b11a96"]
wait = {
    'contact':False,
    'autoJoin':True,
