...
cl = LINETCR.LINE()
cl.login(token="EpW5GVgA4BQOswxPRp69.VyTEP7Rzr5zGDuiTqDk9Iq.A99144Fg3gJs++DCs4ZhWWTM6+m9Do9FS9vbHZENdXs=")
...
Bots=[mid,"ubd8b5ea7bad947966075422d41d2bd89"]
admin=["ubd8b5ea7bad947966075422d41d2bd89"]
wait = {
    'contact':False,
    'autoJoin':True,
