...
cl = LINETCR.LINE()
cl.login(token="EqATQ1cx24XaSIYymezf.0MtpWwdbxRy418dKhc4ClW.n5OEXyecFjkyqWjFXBOaqHaP6DdE0swoQV6W1yl6fao=")

ki = LINETCR.LINE()
ki.login(token="EqZ4dJ0oWdKGOON11Y41.25+JV7lDyjZi9zm0/ZVluq.wyj4q2pa0dQJ33ouEuE4Ptwi+Oehx3WuU2scqERT9W8=")
...
Bots=[mid,Amid,"ud264cfc160c15eb638d7c0e41c2e1c2f","udb9fe3bfb2dd609cc8f59334fb3bcb51"]
admin=["ud264cfc160c15eb638d7c0e41c2e1c2f"]
wait = {
    'contact':False,
    'autoJoin':True,
