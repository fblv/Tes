...
cl = LINETCR.LINE()
cl.login(token="EquSJJRN0GDT9ExSLjq6.gYxKrCkECESoGNjo+D5AXG.yYkIcyLGgCqF5WNe1FdS9KHtDdKxTM9d6T4PX1ODGG4=")

ki = LINETCR.LINE()
ki.login(token="Eqx39NHicmCsh7yMPCJa.OUJk2OaZK4HA5Ypnn2aaoG.p8aIwDAglrNHht8Jb0Oqwa7ogLL3xnRrQuGF0YmFdy0=")

kk = LINETCR.LINE()
kk.login(token="Eq9MvwhFxcm7pGUaI9i7.Dh8gAYzI7J+lfj1J6Drm5W.SSU4EyKwDpdLoInjXKvQ0qvQJxbdXugH+KT86Co74Qs=")

kc = LINETCR.LINE()
kc.login(token="EqswOZJEoibQxxA9IV63.qDz/HqrUPAshUb/OBwJ7CW.4rJxWEmn/pXqjMY8DkHfT3gp5sd0FaWRJljm8amXalc=")

#ks = LINETCR.LINE()
#ks.login(token="EpCZG5PsU9zDI9y2JP1b.GcMK/mE4QSBwCGlHYZjp/W.qu/iQFs4WZKIczUM2s8XW1OcrY0veHJaRhpJIvhhqR4=")

#kr = LINETCR.LINE()
#kr.login(token="EqrVkdf1gZX9CIQfNo25.4vKS0+5LhK/spDj+VvZ7Pq.K0AXZql2mIE5GmsHZW7f+MvBhGCxvMgBOMhgxBvbCzw="))
...
Bots=[mid,Amid,Bmid,Cmid,"u1b25e445c29e71eb0e82724efdde5ac6","ua2e8cada803393885ae723cd3760003a","u747f066b2662ee3fcb149d63e9d44ce7","u41d67e85046ea5a487b81fa86d68fb73"]
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
              if wait ["tag"] == True:
                    ...
                    balas = [cName + "Dont tag me, im busy",cName + " ada apa ngetag?",cName + " PM AJA",cName + "apa😕-_-",cName]
...
#==================================================
                ...
                timenowT = datetime.strftime(timeNow,"(%H:%M)")
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                if wait["protect"] == True:
                     if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protect All On")
                     else:
                        cl.sendText(msg.to,"done")
                else:
                    wait["protect"] = True
              ...
              if msg.from_ in admin:
                if wait["protect"] == False:
                     if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protect All Off")
                     else:
                        cl.sendText(msg.to,"done")
                else:
                    wait["protect"] = False
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u1b25e445c29e71eb0e82724efdde5ac6"}
                cl.sendMessage(msg)
...
#----------------------------------------------------------------------------
       #-------------Fungsi Respon Start---------------------#
                ...
                ki.sendText(msg.to,"グループ  混雑1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"グループ  混雑2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"グループ  混雑3 Hadiir  \(ˆ▿ˆ)/")
