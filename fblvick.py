...
cl = LINETCR.LINE()
cl.login(token="EsbihHJ6cCljGoKg2abc.Pcj+qswFYNoIuSBnPC5oda.N17P6tR4YXk8xTmURKCswUBKyHWqD/IFOFSZCUlwNEI=")
...
KAC=[cl]
DEF=[cl]
Bots=["ua4227f41259fca73a252c6cda5ce4e0c"]
admin=["ua4227f41259fca73a252c6cda5ce4e0c"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "lang":"JP",
    "tag":True,
    "comment":"Auto Like By My Creator : By 􀌂􀄠􏿿􀌂􀄠V҉i҉c҉k҉y",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
